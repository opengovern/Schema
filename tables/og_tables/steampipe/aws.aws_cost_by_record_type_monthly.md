# aws.aws_cost_by_record_type_monthly

## Description

AWS Cost Explorer - Cost by Record Type (Monthly)

## Columns

| Name | Type | Default | Nullable | Children | Parents | Comment |
| ---- | ---- | ------- | -------- | -------- | ------- | ------- |
| linked_account_id | text |  | true |  |  | The linked AWS Account ID. |
| record_type | text |  | true |  |  | The different types of charges such as RI fees, usage, costs, tax refunds, and credits. |
...
![er](aws.aws_cost_by_record_type_monthly.svg)
