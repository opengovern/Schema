# aws.aws_rds_db_instance_metric_read_iops_daily

## Description

AWS RDS DB Instance Cloudwatch Metrics - Read IOPS (Daily)
...
![er](aws.aws_rds_db_instance_metric_read_iops_daily.svg)
