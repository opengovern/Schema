# aws.aws_rds_db_instance_metric_connections_daily

## Description

AWS RDS DB Instance Cloudwatch Metrics - DB Connections (Daily)
...
![er](aws.aws_rds_db_instance_metric_connections_daily.svg)
