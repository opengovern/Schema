# aws.aws_rds_db_instance_metric_read_iops_hourly

## Description

AWS RDS DB Instance Cloudwatch Metrics - Read IOPS (Hourly)
...
![er](aws.aws_rds_db_instance_metric_read_iops_hourly.svg)
