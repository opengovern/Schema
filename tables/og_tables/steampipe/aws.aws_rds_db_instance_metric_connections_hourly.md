# aws.aws_rds_db_instance_metric_connections_hourly

## Description

AWS RDS DB Instance Cloudwatch Metrics - DB Connections (Hourly)
...
![er](aws.aws_rds_db_instance_metric_connections_hourly.svg)
