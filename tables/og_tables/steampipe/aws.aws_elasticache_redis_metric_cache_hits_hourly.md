# aws.aws_elasticache_redis_metric_cache_hits_hourly

## Description

AWS Elasticache Redis CacheHits metric (Hourly)
...
![er](aws.aws_elasticache_redis_metric_cache_hits_hourly.svg)
