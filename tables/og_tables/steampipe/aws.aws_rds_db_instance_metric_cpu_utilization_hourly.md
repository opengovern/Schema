# aws.aws_rds_db_instance_metric_cpu_utilization_hourly

## Description

AWS RDS DB Instance Cloudwatch Metrics - CPU Utilization (Hourly)
...
![er](aws.aws_rds_db_instance_metric_cpu_utilization_hourly.svg)
