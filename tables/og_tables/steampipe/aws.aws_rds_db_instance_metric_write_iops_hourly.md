# aws.aws_rds_db_instance_metric_write_iops_hourly

## Description

AWS RDS DB Instance Cloudwatch Metrics - Write IOPS (Hourly)
...
![er](aws.aws_rds_db_instance_metric_write_iops_hourly.svg)
