# aws.aws_elasticache_redis_metric_new_connections_hourly

## Description

AWS Elasticache Redis NewConnections metric (Hourly)
...
![er](aws.aws_elasticache_redis_metric_new_connections_hourly.svg)
