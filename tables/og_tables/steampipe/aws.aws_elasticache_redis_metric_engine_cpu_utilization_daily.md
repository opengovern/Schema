# aws.aws_elasticache_redis_metric_engine_cpu_utilization_daily

## Description

AWS Elasticache Redis EngineCPUUtilization metric (Daily)
...
![er](aws.aws_elasticache_redis_metric_engine_cpu_utilization_daily.svg)
