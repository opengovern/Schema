# aws.aws_rds_db_instance_metric_cpu_utilization

## Description

AWS RDS DB Instance Cloudwatch Metrics - CPU Utilization
...
![er](aws.aws_rds_db_instance_metric_cpu_utilization.svg)
