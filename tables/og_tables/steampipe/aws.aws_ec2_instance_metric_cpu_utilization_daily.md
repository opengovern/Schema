# aws.aws_ec2_instance_metric_cpu_utilization_daily

## Description

AWS EC2 Instance Cloudwatch Metrics - CPU Utilization (Daily)
...
![er](aws.aws_ec2_instance_metric_cpu_utilization_daily.svg)
