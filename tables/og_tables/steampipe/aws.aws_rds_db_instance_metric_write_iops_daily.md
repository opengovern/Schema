# aws.aws_rds_db_instance_metric_write_iops_daily

## Description

AWS RDS DB Instance Cloudwatch Metrics - Write IOPS (Daily)
...
![er](aws.aws_rds_db_instance_metric_write_iops_daily.svg)
