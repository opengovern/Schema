# aws.aws_elasticache_redis_metric_get_type_cmds_hourly

## Description

AWS Elasticache Redis GetTypeCmds metric(Hourly)
...
![er](aws.aws_elasticache_redis_metric_get_type_cmds_hourly.svg)
